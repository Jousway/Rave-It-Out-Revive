...
t[#t+1] = getWavyText("Rave It Out Revival",SCREEN_CENTER_X,SCREEN_CENTER_Y-100);
t[#t+1] = getWavyText("Jousway and Accelerator",SCREEN_CENTER_X,SCREEN_CENTER_Y);
