...
if RIO.MaxHeartsLeftForAnyPlayer() > 0 then
	--pass, already true
else
...
t[#t+1] = Def.Actor {
	...
	LoadCommand=function()
		...
		for player in ivalues(GAMESTATE:GetHumanPlayers()) do
			...
			if RIO.Hearts["HeartsLeft"][tonumber(string.match(player, "%d"))] < 1 then
...
if RIO.DoDebug then
	...
	t[#t+1] = LoadFont("Common Normal")..{
		...
		Text="P1 HEARTS: "..RIO.Hearts["HeartsLeft"][1].."\nP2 HEARTS: "..RIO.Hearts["HeartsLeft"][2].."\nMAX HEARTS: "..RIO.MaxHeartsLeftForAnyPlayer();
	};
end;
return t;
